...
_CELL_STATS_REPL = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='cell_stats_repl.status', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='prb_utilz', full_name='cell_stats_repl.prb_utilz', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CELL_STATS_REPL.fields_by_name['status'].enum_type = _STATS_REQ_STATUS
