...
class AttThputValidation(EmpowerApp):
    ...
    def rssi_callback(self, ucqm):
        ...
        #loop over the lvaps that this wtp has hear from
        wtp = ucqm.wtp 
    ...
    def loop(self):
        ...
        for wtp in self.wtps() :
            ...
            # The association set for a wtp are the lvaps associated with it.
            # If I have atleast as many samples as required to fill the sliding window. 
...
def launch(tenant_id, every=DEFAULT_PERIOD):
    ...
    return AttThputValidation(tenant_id=tenant_id, every=500)
